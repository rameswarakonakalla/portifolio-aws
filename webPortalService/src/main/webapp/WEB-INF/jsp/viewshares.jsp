			...
			<div class="col-sm-6 ">
				<div class="card text-center shadow-lg">
					<img class="card-img-top img-fluid"
						src="https://mediacloud.kiplinger.com/image/private/s--X-WVjvBW--/f_auto,t_content-image-full-desktop@1/v1602615863/Investing/nasdaq-100-etfs-mutual-funds.jpg"
						style="width: 600x; height: 300px;" alt="Card image cap">
					<div class="card-block">
						<h4 class="card-title">Portfolio Details</h4>

						<p>
						<center>Below are the shares that you own</center>
						</p>
	...
	<br>
		<footer class="footer">
			...
			<div class="container">
				...
				<p class="text-center">
					&copy Copyright @2021 | <a href="https://www.cognizant.com/">Cognizant</a>
				</p>
